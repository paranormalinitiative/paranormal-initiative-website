(function () {
  ...
  window.TPIApi = {
    ...
    updateMemberAccess: (username, payload) => request(`/admin/members/${encodeURIComponent(username || "")}/access`, { method: "POST", body: payload }),
    sendMemberNotification: (username, payload) => request(`/admin/members/${encodeURIComponent(username || "")}/notifications`, { method: "POST", body: payload }),
